...
<!-- Add category modal -->
<?php include('includes/add_inventory_modal.php');?> 
        ...
        <tbody>
            <?php while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                ...
                $total_cost_sum += $row["total_buying_price"];
            ?>
            <tr>
                <td class = "row-number"></td>
                <td><?php echo "<option value=\"{$row['category_name']}\">{$row['category_name']}</option>" ?></td>
                ...
                <td><?php echo $row["total_buying_price"] . " " . "Kshs"; ?></td>

                <td>
                    <!-- Button to trigger the view inventory modal -->
                    <button type="button" class="btn btn-primary view-inventory-btn" data-bs-toggle="modal" data-bs-target="#viewInventoryModal" data-category="<?php echo $row['category_name']; ?>">
                        View
                    </button>
            ...
            <?php } ?>
            <!-- Move the footer row to the end of the tbody section and add the CSS class to hide the row number cell -->
    ...
    <!-- Include view_inventory_modal -->
    <?php include('includes/view_inventory_modal.php');?> 
